...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/**/favicon.ico","/css/**","/js/**","/img/**","/webjars/**","/templates/login.html").permitAll();
		...
		http.formLogin().loginPage("/templates/login.html").loginProcessingUrl("/templates/login").failureUrl("/templates/login.html?loginFailed=true");
